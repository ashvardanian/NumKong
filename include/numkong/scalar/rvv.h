 ...
 */
#ifndef NUMKONG_SCALAR_RVV_H
#define NUMKONG_SCALAR_RVV_H
...
NUMKONG_API_COMPTIME nk_f32_t nk_f32_rsqrt_rvv(nk_f32_t number) {
...
NUMKONG_API_COMPTIME nk_f32_t nk_f32_sqrt_rvv(nk_f32_t number) {
    vfloat32m1_t x_f32m1 = __riscv_vfmv_s_f_f32m1(number, 1);
    return __riscv_vfmv_f_s_f32m1_f32(__riscv_vfsqrt_v_f32m1(x_f32m1, 1));
}

NUMKONG_API_COMPTIME nk_f64_t nk_f64_rsqrt_rvv(nk_f64_t number) {
...
NUMKONG_API_COMPTIME nk_f64_t nk_f64_sqrt_rvv(nk_f64_t number) {
    vfloat64m1_t x_f64m1 = __riscv_vfmv_s_f_f64m1(number, 1);
