 ...
 *  - 8-bit mini-floats (e4m3, e5m2, e2m3, e3m2)
...
nk_sqeuclidean_f64_v128relaxed_cycle:
    if (count_scalars < 2) {
        ...
        nk_load_b128_v128_(a_scalars, &a_vec);
        nk_load_b128_v128_(b_scalars, &b_vec);
        a_scalars += 2, b_scalars += 2, count_scalars -= 2;
    }
...
nk_angular_f32_v128relaxed_cycle:
    ...
    nk_f64_t ab_f64 = nk_reduce_add_f64x2_v128_(ab_f64x2);
    nk_f64_t a2_f64 = nk_reduce_add_f64x2_v128_(a2_f64x2);
    nk_f64_t b2_f64 = nk_reduce_add_f64x2_v128_(b2_f64x2);
...
nk_sqeuclidean_e5m2_v128relaxed_cycle:
    ...
    nk_b128_vec_t a_f32_vec = nk_e5m2x4_to_f32x4_v128_(a_raw);
    nk_b128_vec_t b_f32_vec = nk_e5m2x4_to_f32x4_v128_(b_raw);
    v128_t diff_f32x4 = wasm_f32x4_sub(a_f32_vec.v128, b_f32_vec.v128);
    sum_f32x4 = wasm_f32x4_relaxed_madd(diff_f32x4, diff_f32x4, sum_f32x4);
...
nk_sqeuclidean_e2m3_v128relaxed_cycle:
    ...
    nk_b128_vec_t a_f32_vec = nk_e2m3x4_to_f32x4_v128_(a_raw);
    nk_b128_vec_t b_f32_vec = nk_e2m3x4_to_f32x4_v128_(b_raw);
    v128_t diff_f32x4 = wasm_f32x4_sub(a_f32_vec.v128, b_f32_vec.v128);
    sum_f32x4 = wasm_f32x4_relaxed_madd(diff_f32x4, diff_f32x4, sum_f32x4);
...
nk_sqeuclidean_e3m2_v128relaxed_cycle:
    ...
    nk_b128_vec_t a_f32_vec = nk_e3m2x4_to_f32x4_v128_(a_raw);
    nk_b128_vec_t b_f32_vec = nk_e3m2x4_to_f32x4_v128_(b_raw);
    v128_t diff_f32x4 = wasm_f32x4_sub(a_f32_vec.v128, b_f32_vec.v128);
    sum_f32x4 = wasm_f32x4_relaxed_madd(diff_f32x4, diff_f32x4, sum_f32x4);
...
NUMKONG_HELPER_INLINE void nk_dots_triple_u8_v128relaxed_(nk_u8_t const *a, nk_u8_t const *b, nk_size_t n,
    ...
    while (i + 16 <= n) {
        ...
        biased_ab += nk_reduce_add_i32x4_v128_(dot_ab_i32x4) - 128LL * nk_reduce_add_i32x4_v128_(corr_ab_i32x4);
        biased_aa += nk_reduce_add_i32x4_v128_(dot_aa_i32x4) - 128LL * nk_reduce_add_i32x4_v128_(corr_aa_i32x4);
        biased_bb += nk_reduce_add_i32x4_v128_(dot_bb_i32x4) - 128LL * nk_reduce_add_i32x4_v128_(corr_bb_i32x4);
...
NUMKONG_HELPER_INLINE void nk_dots_triple_i8_v128relaxed_(nk_i8_t const *a, nk_i8_t const *b, nk_size_t n,
    ...
    while (i + 16 <= n) {
        ...
        v128_t corr_aa_i32x4 = wasm_i32x4_extadd_pairwise_i16x8(corr_aa_i16x8);
        v128_t corr_bb_i32x4 = wasm_i32x4_extadd_pairwise_i16x8(corr_bb_i16x8);
        dot_ab_total += nk_reduce_add_i32x4_v128_(dot_ab_i32x4);
        dot_aa_total += nk_reduce_add_i32x4_v128_(dot_aa_i32x4);
        dot_bb_total += nk_reduce_add_i32x4_v128_(dot_bb_i32x4);
        corr_ab_total += nk_reduce_add_i32x4_v128_(corr_ab_i32x4);
        corr_aa_total += nk_reduce_add_i32x4_v128_(corr_aa_i32x4);
        corr_bb_total += nk_reduce_add_i32x4_v128_(corr_bb_i32x4);
    }
    ...
    *dot_ab = dot_ab_total - 128LL * corr_ab_total;
    *dot_aa = dot_aa_total - 128LL * corr_aa_total;
