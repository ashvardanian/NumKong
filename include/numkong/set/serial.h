...
NUMKONG_HELPER_INLINE void nk_jaccard_u1x128_init_serial(nk_jaccard_u1x128_state_serial_t *state) {
    state->intersection_count = 0;
}

NUMKONG_HELPER_INLINE void nk_jaccard_u1x128_update_serial(nk_jaccard_u1x128_state_serial_t *state, nk_b128_vec_t a,
...
NUMKONG_HELPER_INLINE void nk_jaccard_u1x128_finalize_serial( //
...
NUMKONG_HELPER_INLINE void nk_hamming_u1x128_init_serial(nk_hamming_u1x128_state_serial_t *state) {
    state->intersection_count = 0;
}

NUMKONG_HELPER_INLINE void nk_hamming_u1x128_update_serial(nk_hamming_u1x128_state_serial_t *state, nk_b128_vec_t a,
                                                           nk_b128_vec_t b, nk_size_t depth_offset,
                                                           nk_size_t active_dimensions) {
    nk_unused_(depth_offset);
    nk_unused_(active_dimensions);
...
NUMKONG_HELPER_INLINE void nk_hamming_u1x128_finalize_serial( //
