...
NUMKONG_HELPER_INLINE v128_t nk_attention_load_bf16x4_v128_(void const *plane_chunk) {
    nk_b64_vec_t raw_vec;
    raw_vec.u64 = *(nk_u64_t const *)plane_chunk;
    return nk_bf16x4_to_f32x4_v128_(raw_vec).v128;
}

NUMKONG_HELPER_INLINE nk_size_t nk_attention_pack_size_v128_(nk_size_t key_value_head_count, nk_size_t depth,
...
NUMKONG_HELPER_INLINE void nk_attention_pack_v128_(                                    //
...
NUMKONG_API_COMPTIME void nk_attention_pack_bf16_v128(                                 //
...
NUMKONG_API_COMPTIME void nk_attention_pack_e4m3_v128(                                 //
...
NUMKONG_API_COMPTIME void nk_attention_pack_i8_v128(                                   //
