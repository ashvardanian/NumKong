...
NUMKONG_HELPER_DEVICE_INLINE unsigned short nk_f32x2_to_e4m3x2_blackwellrtx_(nk_f32_t low, nk_f32_t high) {
    unsigned short pair;
...
NUMKONG_HELPER_DEVICE_INLINE nk_u32_t nk_e4m3x2_to_f16x2_blackwellrtx_(unsigned short pair) {
    nk_u32_t halves;
...
NUMKONG_HELPER_DEVICE_INLINE void nk_attention_scores_e4m3_blackwellrtx_(nk_fui32_t scores[2][4],
                                                                         nk_u32_t const query[8],
...
NUMKONG_HELPER_DEVICE_INLINE void nk_attention_weights_e4m3_blackwellrtx_(nk_f32_t const probabilities[4],
