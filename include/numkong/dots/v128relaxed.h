...
nk_define_cross_compensated_symmetric_(dots, u8, v128relaxed, u8, u32,
                                       ...
                                       nk_load_b128_v128_, nk_partial_load_b8x16_serial_,
                                       nk_dot_u8x16_update_v128relaxed, nk_dot_u8x16_finalize_v128relaxed,
                                       nk_store_b128_v128_, nk_partial_store_b32x4_serial_, nk_load_b128_v128_,
                                       nk_partial_load_b32x4_serial_, nk_sum_u8x16_state_v128_t,
                                       nk_sum_u8x16_init_v128, //
                                       nk_sum_u8x16_update_v128, nk_sum_u8x16_finalize_v128,
                                       /*depth_simd_dimensions=*/16, /*dimensions_per_value=*/1)
nk_define_cross_compensated_packed_(dots, u8, v128relaxed, u8, u8, u32,
                                    /*sum_value_type=*/u32, /*norm_value_type=*/u32, nk_b128_vec_t,
                                    nk_dot_u8x16_state_v128relaxed_t, nk_b128_vec_t, nk_dot_u8x16_init_v128relaxed,
                                    nk_load_b128_v128_, nk_partial_load_b8x16_serial_, nk_load_b128_v128_,
...
nk_define_cross_pack_size_(dots, e2m3, v128relaxed, e2m3, e2m3, /*norm_value_type=*/f32,
...
nk_define_cross_symmetric_(dots, e2m1, v128relaxed, e2m1x2, f32, nk_b128_vec_t, nk_dot_e2m1x32_state_v128relaxed_t,
                           ...
                           nk_partial_load_e2m1x32_serial_, nk_dot_e2m1x32_update_v128relaxed,
...
nk_define_cross_packed_(dots, e2m1, v128relaxed, e2m1x2, e2m1x2, f32, nk_b128_vec_t, nk_dot_e2m1x32_state_v128relaxed_t,
                        nk_b128_vec_t, nk_dot_e2m1x32_init_v128relaxed, nk_load_b128_v128_,
                        nk_partial_load_e2m1x32_serial_, nk_load_b128_v128_, nk_partial_load_e2m1x32_serial_,
...
nk_define_cross_pack_size_(dots, bf16, v128relaxed, bf16, bf16, /*norm_value_type=*/f32,
...
nk_define_cross_packed_shape_(dots, i4, v128relaxed)
...
nk_define_cross_compensated_symmetric_(dots, i4, v128relaxed, i4x2, i32,
                                       ...
                                       nk_load_b128_v128_, nk_partial_load_b4x32_serial_,
                                       nk_dot_i4x32_update_v128relaxed, nk_dot_i4x32_finalize_v128relaxed,
                                       nk_store_b128_v128_, nk_partial_store_b32x4_serial_, nk_load_b128_v128_,
                                       nk_partial_load_b32x4_serial_, nk_sum_i4x32_state_v128_t,
                                       nk_sum_i4x32_init_v128, //
                                       nk_sum_i4x32_update_v128, nk_sum_i4x32_finalize_v128,
                                       /*depth_simd_dimensions=*/32, /*dimensions_per_value=*/2)
nk_define_cross_compensated_packed_(dots, i4, v128relaxed, i4x2, i4x2, i32,
                                    /*sum_value_type=*/i32, /*norm_value_type=*/u32, nk_b128_vec_t,
                                    nk_dot_i4x32_state_v128relaxed_t, nk_b128_vec_t, nk_dot_i4x32_init_v128relaxed,
                                    nk_load_b128_v128_, nk_partial_load_b4x32_serial_, nk_load_b128_v128_,
