...
NK_API_COMPTIME void nk_cast_v128relaxed(void const *from, nk_dtype_t from_type, nk_size_t n, void *to,
    ...
    for (nk_size_t i = 0; i < batches; ++i, from_ptr += from_step, to_ptr += to_step) {
        ...
        if (from_step == 16) { hub_vec.v128 = wasm_v128_load(from_ptr); }
            ...
            case nk_e3m2_k: hub_vec = nk_e3m2x4_to_f32x4_v128_(raw32_vec); break;
            case nk_i8_k: hub_vec = nk_i8x4_to_f32x4_v128_(raw32_vec); break;
            case nk_u8_k: hub_vec = nk_u8x4_to_f32x4_v128_(raw32_vec); break;
            default: break;
            }
        }
        ...
        case nk_i8_k: *(nk_u32_t *)to_ptr = nk_f32x4_to_i8x4_v128_(hub_vec).u32; break;
        case nk_u8_k: *(nk_u32_t *)to_ptr = nk_f32x4_to_u8x4_v128_(hub_vec).u32; break;
        default: break;
        }
    }
