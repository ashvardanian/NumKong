...
NK_HELPER_INLINE __m256h nk_e5m2x16_to_f16x16_sapphire_(__m128i e5m2_i8x16) {
    ...
    // Subnormal fix: for exp==0 lanes, use (subnorm_abs | sign); else keep normal
    __mmask16 is_subnormal_m16 = _mm256_testn_epi16_mask(e5m2_i16x16, _mm256_set1_epi16(0x7C));
    __m256h subnorm_abs_f16x16 = _mm256_mul_ph(_mm256_cvtepi16_ph(mantissa_i16x16),
...
NK_HELPER_INLINE __m128i nk_f16x16_to_e4m3x16_sapphire_(__m256h f16x16) {
    ...
    __mmask16 is_subnormal_m16 = _mm256_cmpgt_epi16_mask(_mm256_set1_epi16(1), e4m3_exp_i16x16);
    __mmask16 overflow_m16 = _mm256_cmpgt_epi16_mask(e4m3_exp_i16x16, _mm256_set1_epi16(15));
    ...
    __mmask16 is_max_exp_m16 = _mm256_cmpeq_epi16_mask(clamped_exp_i16x16, _mm256_set1_epi16(15));
    __m256i max_mantissa_i16x16 = _mm256_mask_blend_epi16(is_max_exp_m16, _mm256_set1_epi16(7), _mm256_set1_epi16(6));
    __m256i normal_mantissa_i16x16 = _mm256_min_epi16(f16_mantissa_i16x16, max_mantissa_i16x16);
    normal_mantissa_i16x16 = _mm256_mask_blend_epi16(overflow_m16, normal_mantissa_i16x16, _mm256_set1_epi16(0x06));
    ...
    __mmask16 promotes_to_normal_m16 = _mm256_cmpgt_epi16_mask(subnorm_mantissa_i16x16, _mm256_set1_epi16(7));
    ...
    subnorm_e4m3_i16x16 = _mm256_mask_blend_epi16(promotes_to_normal_m16, subnorm_e4m3_i16x16,
                                                  first_normal_e4m3_i16x16);
...
NK_HELPER_INLINE __m128i nk_f16x16_to_e5m2x16_sapphire_(__m256h f16x16) {
    ...
    __m256i normal_mantissa_i16x16 = _mm256_mask_blend_epi16(overflow_m16, f16_mantissa_i16x16, _mm256_setzero_si256());
