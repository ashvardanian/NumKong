 ...
 *  Apple M4+ use 128-bit. Code using svcnth() adapts automatically, but wider vectors process more
 *  elements per iteration with identical latencies.
 *
 *  The BFDOT instruction fuses two BF16 multiplications with FP32 accumulation per lane, providing
