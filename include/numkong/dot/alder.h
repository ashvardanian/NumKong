...
NK_HELPER_INLINE void nk_dot_e2m1x64_update_alder(nk_dot_e2m1x64_state_alder_t *state, nk_b256_vec_t a, nk_b256_vec_t b,
    ...
    // VPDPBUSD wants u8 × i8: move the sign of `a` onto `b`
    state->sum_i32x8 = _mm256_dpbusd_avx_epi32(state->sum_i32x8, _mm256_abs_epi8(a_low_i8x32),
                                               _mm256_sign_epi8(b_low_i8x32, a_low_i8x32));
    state->sum_i32x8 = _mm256_dpbusd_avx_epi32(state->sum_i32x8, _mm256_abs_epi8(a_high_i8x32),
