...
nk_each_sum_f64_skylake_cycle:
    if (n < 8) {
        ...
        a_vec = _mm512_maskz_loadu_pd(mask_m8, a);
        b_vec = _mm512_maskz_loadu_pd(mask_m8, b);
        n = 0;
    }
    else {
...
nk_each_blend_f32_skylake_cycle:
    if (n < 16) {
        mask_m16 = (__mmask16)_bzhi_u32(0xFFFFFFFF, n);
        a_f32x16 = _mm512_maskz_loadu_ps(mask_m16, a);
        b_f32x16 = _mm512_maskz_loadu_ps(mask_m16, b);
        n = 0;
    }
    else {
        a_f32x16 = _mm512_loadu_ps(a);
...
nk_each_blend_bf16_skylake_cycle:
    if (n < 16) {
        mask_m16 = (__mmask16)_bzhi_u32(0xFFFFFFFF, n);
        a_bf16x16 = _mm256_maskz_loadu_epi16(mask_m16, a);
        b_bf16x16 = _mm256_maskz_loadu_epi16(mask_m16, b);
        n = 0;
    }
    else {
        a_bf16x16 = _mm256_loadu_epi16(a);
...
nk_each_fma_f64_skylake_cycle:
    if (n < 8) {
        ...
        a_f64x8 = _mm512_maskz_loadu_pd(mask_m8, a);
        b_f64x8 = _mm512_maskz_loadu_pd(mask_m8, b);
        c_f64x8 = _mm512_maskz_loadu_pd(mask_m8, c);
        n = 0;
    }
    else {
        a_f64x8 = _mm512_loadu_pd(a);
...
nk_each_fma_f32_skylake_cycle:
    if (n < 16) {
        ...
        a_f32x16 = _mm512_maskz_loadu_ps(mask_m16, a);
        b_f32x16 = _mm512_maskz_loadu_ps(mask_m16, b);
        c_f32x16 = _mm512_maskz_loadu_ps(mask_m16, c);
        n = 0;
    }
    else {
        a_f32x16 = _mm512_loadu_ps(a);
...
nk_each_fma_bf16_skylake_cycle:
    if (n < 16) {
        ...
        a_bf16x16 = _mm256_maskz_loadu_epi16(mask_m16, a);
        b_bf16x16 = _mm256_maskz_loadu_epi16(mask_m16, b);
        c_bf16x16 = _mm256_maskz_loadu_epi16(mask_m16, c);
        n = 0;
    }
    else {
        a_bf16x16 = _mm256_loadu_epi16(a);
...
NUMKONG_API_COMPTIME void nk_each_scale_i8_skylake(nk_i8_t const *a, nk_size_t n, nk_f32_t const *alpha,
    ...
    __m512 a_f32x16, result_f32x16;
    __mmask16 mask_m16 = 0xFFFF, ordered_m16;
    __m512i result_i32x16;
    __m512 min_f32x16 = _mm512_set1_ps(-128.0f);
    __m512 max_f32x16 = _mm512_set1_ps(127.0f);

nk_each_scale_i8_skylake_cycle:
    if (n < 16) {
        mask_m16 = (__mmask16)_bzhi_u32(0xFFFFFFFF, n);
        a_i8x16 = _mm_maskz_loadu_epi8(mask_m16, a);
        n = 0;
    }
    else {
    ...
    result_f32x16 = _mm512_fmadd_ps(a_f32x16, alpha_f32x16, beta_f32x16);
    ordered_m16 = _mm512_cmp_ps_mask(result_f32x16, result_f32x16, _CMP_ORD_Q);
    result_f32x16 = _mm512_max_ps(result_f32x16, min_f32x16);
    result_f32x16 = _mm512_min_ps(result_f32x16, max_f32x16);
    result_i32x16 = _mm512_maskz_cvtps_epi32(ordered_m16, result_f32x16);
...
NUMKONG_API_COMPTIME void nk_each_blend_i8_skylake(nk_i8_t const *a, nk_i8_t const *b, nk_size_t n,
    ...
    __m512 alpha_f32x16 = _mm512_set1_ps(alpha_val);
    __m512 beta_f32x16 = _mm512_set1_ps(beta_val);
    __m128i a_i8x16, b_i8x16, result_i8x16;
    __m512 a_scaled_f32x16, b_scaled_f32x16, result_f32x16;
    __mmask16 mask_m16 = 0xFFFF, ordered_m16;
    __m512i result_i32x16;
    __m512 min_f32x16 = _mm512_set1_ps(-128.0f);
    __m512 max_f32x16 = _mm512_set1_ps(127.0f);

nk_each_blend_i8_skylake_cycle:
    if (n < 16) {
        mask_m16 = (__mmask16)_bzhi_u32(0xFFFFFFFF, n);
        a_i8x16 = _mm_maskz_loadu_epi8(mask_m16, a);
        b_i8x16 = _mm_maskz_loadu_epi8(mask_m16, b);
        n = 0;
    }
    else {
        a_i8x16 = _mm_loadu_si128((__m128i *)a);
    ...
    a_scaled_f32x16 = _mm512_mul_ps(_mm512_cvtepi32_ps(_mm512_cvtepi8_epi32(a_i8x16)), alpha_f32x16);
    b_scaled_f32x16 = _mm512_mul_ps(_mm512_cvtepi32_ps(_mm512_cvtepi8_epi32(b_i8x16)), beta_f32x16);
...
nk_each_fma_i8_skylake_cycle:
    if (n < 16) {
        ...
        a_i8x16 = _mm_maskz_loadu_epi8(mask_m16, a);
        b_i8x16 = _mm_maskz_loadu_epi8(mask_m16, b);
        c_i8x16 = _mm_maskz_loadu_epi8(mask_m16, c);
        n = 0;
    }
    else {
        a_i8x16 = _mm_loadu_si128((__m128i *)a);
...
NUMKONG_API_COMPTIME void nk_each_scale_u8_skylake(nk_u8_t const *a, nk_size_t n, nk_f32_t const *alpha,
    ...
    __m512 max_f32x16 = _mm512_set1_ps(255.0f);

nk_each_scale_u8_skylake_cycle:
    if (n < 16) {
        mask_m16 = (__mmask16)_bzhi_u32(0xFFFFFFFF, n);
        a_u8x16 = _mm_maskz_loadu_epi8(mask_m16, a);
        n = 0;
    }
    else {
...
NUMKONG_API_COMPTIME void nk_each_blend_u8_skylake(nk_u8_t const *a, nk_u8_t const *b, nk_size_t n,
    ...
    __m512 alpha_f32x16 = _mm512_set1_ps(alpha_val);
    __m512 beta_f32x16 = _mm512_set1_ps(beta_val);
    __m128i a_u8x16, b_u8x16, result_u8x16;
    __m512 a_scaled_f32x16, b_scaled_f32x16, result_f32x16;
    __mmask16 mask_m16 = 0xFFFF;
    __m512i result_u32x16;
    __m512 min_f32x16 = _mm512_setzero_ps();
...
nk_each_blend_u8_skylake_cycle:
    if (n < 16) {
        mask_m16 = (__mmask16)_bzhi_u32(0xFFFFFFFF, n);
        a_u8x16 = _mm_maskz_loadu_epi8(mask_m16, a);
        b_u8x16 = _mm_maskz_loadu_epi8(mask_m16, b);
        n = 0;
    }
    else {
        a_u8x16 = _mm_loadu_si128((__m128i *)a);
    ...
    // Unfused, like the serial kernel, so the two agree bit for bit
    a_scaled_f32x16 = _mm512_mul_ps(_mm512_cvtepi32_ps(_mm512_cvtepu8_epi32(a_u8x16)), alpha_f32x16);
    b_scaled_f32x16 = _mm512_mul_ps(_mm512_cvtepi32_ps(_mm512_cvtepu8_epi32(b_u8x16)), beta_f32x16);
    result_f32x16 = _mm512_add_ps(a_scaled_f32x16, b_scaled_f32x16);
    result_f32x16 = _mm512_max_ps(result_f32x16, min_f32x16);
    result_f32x16 = _mm512_min_ps(result_f32x16, max_f32x16);
    result_u32x16 = _mm512_cvtps_epu32(result_f32x16);
...
nk_each_fma_u8_skylake_cycle:
    if (n < 16) {
        ...
        a_u8x16 = _mm_maskz_loadu_epi8(mask_m16, a);
        b_u8x16 = _mm_maskz_loadu_epi8(mask_m16, b);
        c_u8x16 = _mm_maskz_loadu_epi8(mask_m16, c);
        n = 0;
    }
    else {
        a_u8x16 = _mm_loadu_si128((__m128i *)a);
...
nk_each_scale_i16_skylake_cycle:
    if (n < 16) {
        mask_m16 = (__mmask16)_bzhi_u32(0xFFFFFFFF, n);
        a_i16x16 = _mm256_maskz_loadu_epi16(mask_m16, a);
        n = 0;
    }
    else {
...
nk_each_fma_i16_skylake_cycle:
    if (n < 16) {
        mask_m16 = (__mmask16)_bzhi_u32(0xFFFFFFFF, n);
        a_i16x16 = _mm256_maskz_loadu_epi16(mask_m16, a);
        b_i16x16 = _mm256_maskz_loadu_epi16(mask_m16, b);
        c_i16x16 = _mm256_maskz_loadu_epi16(mask_m16, c);
        n = 0;
    }
    else {
        a_i16x16 = _mm256_loadu_si256((__m256i *)a);
...
nk_each_scale_u16_skylake_cycle:
    if (n < 16) {
        mask_m16 = (__mmask16)_bzhi_u32(0xFFFFFFFF, n);
        a_u16x16 = _mm256_maskz_loadu_epi16(mask_m16, a);
        n = 0;
    }
    else {
...
nk_each_fma_u16_skylake_cycle:
    if (n < 16) {
        mask_m16 = (__mmask16)_bzhi_u32(0xFFFFFFFF, n);
        a_u16x16 = _mm256_maskz_loadu_epi16(mask_m16, a);
        b_u16x16 = _mm256_maskz_loadu_epi16(mask_m16, b);
        c_u16x16 = _mm256_maskz_loadu_epi16(mask_m16, c);
        n = 0;
    }
    else {
        a_u16x16 = _mm256_loadu_si256((__m256i *)a);
...
NUMKONG_API_COMPTIME void nk_each_scale_i32_skylake(nk_i32_t const *a, nk_size_t n, nk_f64_t const *alpha,
    ...
    __m512d a_f64x8, result_f64x8;
    __mmask8 mask_m8 = 0xFF, ordered_m8;
...
nk_each_scale_i32_skylake_cycle:
    if (n < 8) {
        mask_m8 = (__mmask8)_bzhi_u32(0xFFFFFFFF, n);
        a_i32x8 = _mm256_maskz_loadu_epi32(mask_m8, a);
        n = 0;
    }
    else {
    ...
    result_f64x8 = _mm512_fmadd_pd(a_f64x8, alpha_f64x8, beta_f64x8);
    ordered_m8 = _mm512_cmp_pd_mask(result_f64x8, result_f64x8, _CMP_ORD_Q);
    result_f64x8 = _mm512_max_pd(result_f64x8, min_f64x8);
    result_f64x8 = _mm512_min_pd(result_f64x8, max_f64x8);
    result_i32x8 = _mm512_maskz_cvtpd_epi32(ordered_m8, result_f64x8);
...
nk_each_fma_i32_skylake_cycle:
    if (n < 8) {
        mask_m8 = (__mmask8)_bzhi_u32(0xFFFFFFFF, n);
        a_i32x8 = _mm256_maskz_loadu_epi32(mask_m8, a);
        b_i32x8 = _mm256_maskz_loadu_epi32(mask_m8, b);
        c_i32x8 = _mm256_maskz_loadu_epi32(mask_m8, c);
        n = 0;
    }
    else {
        a_i32x8 = _mm256_loadu_si256((__m256i *)a);
...
nk_each_scale_u32_skylake_cycle:
    if (n < 8) {
        mask_m8 = (__mmask8)_bzhi_u32(0xFFFFFFFF, n);
        a_u32x8 = _mm256_maskz_loadu_epi32(mask_m8, a);
        n = 0;
    }
    else {
...
nk_each_fma_u32_skylake_cycle:
    if (n < 8) {
        mask_m8 = (__mmask8)_bzhi_u32(0xFFFFFFFF, n);
        a_u32x8 = _mm256_maskz_loadu_epi32(mask_m8, a);
        b_u32x8 = _mm256_maskz_loadu_epi32(mask_m8, b);
        c_u32x8 = _mm256_maskz_loadu_epi32(mask_m8, c);
        n = 0;
    }
    else {
        a_u32x8 = _mm256_loadu_si256((__m256i *)a);
...
NUMKONG_API_COMPTIME void nk_each_scale_i64_skylake(nk_i64_t const *a, nk_size_t n, nk_f64_t const *alpha,
    ...
    __mmask8 mask_m8 = 0xFF, ordered_m8, overflow_m8;

nk_each_scale_i64_skylake_cycle:
    if (n < 8) {
        mask_m8 = (__mmask8)_bzhi_u32(0xFFFFFFFF, n);
        a_i64x8 = _mm512_maskz_loadu_epi64(mask_m8, a);
        n = 0;
    }
    else {
    ...
    result_f64x8 = _mm512_fmadd_pd(a_f64x8, alpha_f64x8, beta_f64x8);
    // Out-of-range lanes convert to INT64_MIN, which is only right for the negative ones
    ordered_m8 = _mm512_cmp_pd_mask(result_f64x8, result_f64x8, _CMP_ORD_Q);
    overflow_m8 = _mm512_cmp_pd_mask(result_f64x8, _mm512_set1_pd(9223372036854775808.0), _CMP_GE_OQ);
    result_i64x8 = _mm512_maskz_cvtpd_epi64(ordered_m8, result_f64x8);
    result_i64x8 = _mm512_mask_mov_epi64(result_i64x8, overflow_m8, _mm512_set1_epi64(NUMKONG_I64_MAX));
...
nk_each_fma_i64_skylake_cycle:
    if (n < 8) {
        mask_m8 = (__mmask8)_bzhi_u32(0xFFFFFFFF, n);
        a_i64x8 = _mm512_maskz_loadu_epi64(mask_m8, a);
        b_i64x8 = _mm512_maskz_loadu_epi64(mask_m8, b);
        c_i64x8 = _mm512_maskz_loadu_epi64(mask_m8, c);
        n = 0;
    }
    else {
        a_i64x8 = _mm512_loadu_si512((__m512i *)a);
...
nk_each_scale_u64_skylake_cycle:
    if (n < 8) {
        mask_m8 = (__mmask8)_bzhi_u32(0xFFFFFFFF, n);
        a_u64x8 = _mm512_maskz_loadu_epi64(mask_m8, a);
        n = 0;
    }
    else {
    ...
    result_f64x8 = _mm512_fmadd_pd(a_f64x8, alpha_f64x8, beta_f64x8);
    // NaNs and negatives clamp to zero, while 2⁶⁴ and beyond already convert to UINT64_MAX
    result_u64x8 = _mm512_cvtpd_epu64(_mm512_max_pd(result_f64x8, _mm512_setzero_pd()));
...
nk_each_fma_u64_skylake_cycle:
    if (n < 8) {
        mask_m8 = (__mmask8)_bzhi_u32(0xFFFFFFFF, n);
        a_u64x8 = _mm512_maskz_loadu_epi64(mask_m8, a);
        b_u64x8 = _mm512_maskz_loadu_epi64(mask_m8, b);
        c_u64x8 = _mm512_maskz_loadu_epi64(mask_m8, c);
        n = 0;
    }
    else {
        a_u64x8 = _mm512_loadu_si512((__m512i *)a);
...
nk_each_sum_e4m3_skylake_cycle:
    if (n < 16) {
        mask_m16 = (__mmask16)_bzhi_u32(0xFFFF, (unsigned int)n);
        a_e4m3x16 = _mm_maskz_loadu_epi8(mask_m16, a);
        b_e4m3x16 = _mm_maskz_loadu_epi8(mask_m16, b);
        n = 0;
    }
    else {
...
nk_each_sum_e5m2_skylake_cycle:
    if (n < 16) {
        mask_m16 = (__mmask16)_bzhi_u32(0xFFFF, (unsigned int)n);
        a_e5m2x16 = _mm_maskz_loadu_epi8(mask_m16, a);
        b_e5m2x16 = _mm_maskz_loadu_epi8(mask_m16, b);
        n = 0;
    }
    else {
...
nk_each_fma_e4m3_skylake_cycle:
    if (n < 16) {
        ...
        a_e4m3x16 = _mm_maskz_loadu_epi8(mask_m16, a);
        b_e4m3x16 = _mm_maskz_loadu_epi8(mask_m16, b);
        c_e4m3x16 = _mm_maskz_loadu_epi8(mask_m16, c);
        n = 0;
    }
    else {
        a_e4m3x16 = _mm_loadu_si128((__m128i const *)a);
...
nk_each_fma_e5m2_skylake_cycle:
    if (n < 16) {
        ...
        a_e5m2x16 = _mm_maskz_loadu_epi8(mask_m16, a);
        b_e5m2x16 = _mm_maskz_loadu_epi8(mask_m16, b);
        c_e5m2x16 = _mm_maskz_loadu_epi8(mask_m16, c);
        n = 0;
    }
    else {
        a_e5m2x16 = _mm_loadu_si128((__m128i const *)a);
...
nk_each_blend_f16_skylake_cycle:
    if (n < 16) {
        __mmask16 mask_m16 = (__mmask16)_bzhi_u32(0xFFFF, n);
        a_f32x16 = _mm512_cvtph_ps(_mm256_maskz_loadu_epi16(mask_m16, a));
        b_f32x16 = _mm512_cvtph_ps(_mm256_maskz_loadu_epi16(mask_m16, b));
...
nk_each_fma_f16_skylake_cycle:
    if (n < 16) {
        ...
        a_f32x16 = _mm512_cvtph_ps(_mm256_maskz_loadu_epi16(mask_m16, a));
        b_f32x16 = _mm512_cvtph_ps(_mm256_maskz_loadu_epi16(mask_m16, b));
        c_f32x16 = _mm512_cvtph_ps(_mm256_maskz_loadu_epi16(mask_m16, c));
    ...
    for (nk_size_t row = 0; row != rows; ++row) {
        ...
        for (; col + 16 <= cols; col += 16) {
            __m512 result_f32x16 = nk_silu_f32x16_skylake_(
                _mm512_mul_ps(_mm512_loadu_ps(gate_row + col), scale_f32x16));
            if (up_row)
                result_f32x16 = _mm512_mul_ps(result_f32x16,
                                              _mm512_mul_ps(_mm512_loadu_ps(up_row + col), scale_f32x16));
            _mm512_storeu_ps(y_row + col, result_f32x16);
        }
        if (col < cols) {
            __mmask16 mask_m16 = (__mmask16)_bzhi_u32(0xFFFFu, (unsigned)(cols - col));
            __m512 result_f32x16 = nk_silu_f32x16_skylake_(
                _mm512_mul_ps(_mm512_maskz_loadu_ps(mask_m16, gate_row + col), scale_f32x16));
            if (up_row)
                result_f32x16 = _mm512_mul_ps(
                    result_f32x16, _mm512_mul_ps(_mm512_maskz_loadu_ps(mask_m16, up_row + col), scale_f32x16));
...
NUMKONG_API_COMPTIME void nk_each_swiglu_bf16_skylake(nk_bf16_t const *gate, nk_bf16_t const *up, nk_bf16_t *y,
    ...
    for (nk_size_t row = 0; row != rows; ++row) {
        ...
        for (; col + 16 <= cols; col += 16) {
            ...
            nk_load_bf16x16_to_f32x16_skylake_(gate_row + col, &gate_vec);
            __m512 result_f32x16 = nk_silu_f32x16_skylake_(_mm512_mul_ps(gate_vec.zmm_ps, scale_f32x16));
            if (up_row) {
                nk_b512_vec_t up_vec;
                nk_load_bf16x16_to_f32x16_skylake_(up_row + col, &up_vec);
                result_f32x16 = _mm512_mul_ps(result_f32x16, _mm512_mul_ps(up_vec.zmm_ps, scale_f32x16));
            }
            _mm256_storeu_si256((__m256i *)(y_row + col), nk_f32x16_to_bf16x16_skylake_(result_f32x16));
        }
        if (col < cols) {
            nk_size_t remaining = cols - col;
            __mmask16 mask_m16 = (__mmask16)_bzhi_u32(0xFFFFu, (unsigned)remaining);
            nk_b512_vec_t gate_vec;
            nk_partial_load_bf16x16_to_f32x16_skylake_(gate_row + col, &gate_vec, remaining);
            __m512 result_f32x16 = nk_silu_f32x16_skylake_(_mm512_mul_ps(gate_vec.zmm_ps, scale_f32x16));
            if (up_row) {
                nk_b512_vec_t up_vec;
                nk_partial_load_bf16x16_to_f32x16_skylake_(up_row + col, &up_vec, remaining);
                result_f32x16 = _mm512_mul_ps(result_f32x16, _mm512_mul_ps(up_vec.zmm_ps, scale_f32x16));
            }
...
NUMKONG_API_COMPTIME void nk_each_swiglu_e4m3_skylake(nk_e4m3_t const *gate, nk_e4m3_t const *up, nk_e4m3_t *y,
    ...
    for (nk_size_t row = 0; row != rows; ++row) {
        ...
        for (; col + 16 <= cols; col += 16) {
            nk_b512_vec_t gate_vec;
            nk_load_e4m3x16_to_f32x16_skylake_(gate_row + col, &gate_vec);
            __m512 result_f32x16 = nk_silu_f32x16_skylake_(_mm512_mul_ps(gate_vec.zmm_ps, scale_f32x16));
            if (up_row) {
                nk_b512_vec_t up_vec;
                nk_load_e4m3x16_to_f32x16_skylake_(up_row + col, &up_vec);
                result_f32x16 = _mm512_mul_ps(result_f32x16, _mm512_mul_ps(up_vec.zmm_ps, scale_f32x16));
            }
            _mm_storeu_si128((__m128i *)(y_row + col), nk_f32x16_to_e4m3x16_skylake_(result_f32x16));
        }
        if (col < cols) {
            nk_size_t remaining = cols - col;
            __mmask16 mask_m16 = (__mmask16)_bzhi_u32(0xFFFFu, (unsigned)remaining);
            nk_b512_vec_t gate_vec;
            nk_partial_load_e4m3x16_to_f32x16_skylake_(gate_row + col, &gate_vec, remaining);
            __m512 result_f32x16 = nk_silu_f32x16_skylake_(_mm512_mul_ps(gate_vec.zmm_ps, scale_f32x16));
            if (up_row) {
                nk_b512_vec_t up_vec;
                nk_partial_load_e4m3x16_to_f32x16_skylake_(up_row + col, &up_vec, remaining);
                result_f32x16 = _mm512_mul_ps(result_f32x16, _mm512_mul_ps(up_vec.zmm_ps, scale_f32x16));
            }
