...
void bench_cross_amx() {
    ...
    run_dots_packed<bf16_k>("dots_packed_bf16_sapphireamx", nk_dots_pack_size_bf16_sapphireamx,
                            nk_dots_pack_bf16_sapphireamx, nk_dots_packed_bf16_sapphireamx);
    run_dots_packed<e5m2_k>("dots_packed_e5m2_sapphireamx", nk_dots_pack_size_e5m2_sapphireamx,
                            nk_dots_pack_e5m2_sapphireamx, nk_dots_packed_e5m2_sapphireamx);
    run_dots_packed<e4m3_k>("dots_packed_e4m3_sapphireamx", nk_dots_pack_size_e4m3_sapphireamx,
                            nk_dots_pack_e4m3_sapphireamx, nk_dots_packed_e4m3_sapphireamx);
    run_dots_packed<e3m2_k>("dots_packed_e3m2_sapphireamx", nk_dots_pack_size_e3m2_sapphireamx,
    ...
    run_attention_bidirectional<bf16_k>("attention_bidirectional_packed_bf16_sapphireamx",
    ...
    run_attention_causal<bf16_k>("attention_causal_packed_bf16_sapphireamx", nk_attention_pack_size_bf16_sapphireamx,
                                 nk_attention_pack_bf16_sapphireamx, nk_attention_causal_packed_bf16_sapphireamx);
    run_attention_bidirectional<e4m3_k>("attention_bidirectional_packed_e4m3_sapphireamx",
    ...
    run_attention_causal<e4m3_k>("attention_causal_packed_e4m3_sapphireamx", nk_attention_pack_size_e4m3_sapphireamx,
                                 nk_attention_pack_e4m3_sapphireamx, nk_attention_causal_packed_e4m3_sapphireamx);
    run_attention_bidirectional<i8_k>("attention_bidirectional_packed_i8_sapphireamx",
                                      nk_attention_pack_size_i8_sapphireamx, nk_attention_pack_i8_sapphireamx,
                                      nk_attention_bidirectional_packed_i8_sapphireamx);
    run_attention_causal<i8_k>("attention_causal_packed_i8_sapphireamx", nk_attention_pack_size_i8_sapphireamx,
                               nk_attention_pack_i8_sapphireamx, nk_attention_causal_packed_i8_sapphireamx);
#endif

#if NK_TARGET_GRANITEAMX
    run_dots_packed<f16_k>("dots_packed_f16_graniteamx", nk_dots_pack_size_f16_graniteamx, nk_dots_pack_f16_graniteamx,
                           nk_dots_packed_f16_graniteamx);
    run_dots_symmetric<f16_k>("dots_symmetric_f16_graniteamx", nk_dots_symmetric_f16_graniteamx);

    run_angulars_packed<f16_k>("angulars_packed_f16_graniteamx", nk_dots_pack_size_f16_graniteamx,
    ...
    run_euclideans_packed<f16_k>("euclideans_packed_f16_graniteamx", nk_dots_pack_size_f16_graniteamx,
    ...
    run_dots_packed<e5m2_k>("dots_packed_e5m2_graniteamx", nk_dots_pack_size_e5m2_graniteamx,
    ...
    run_angulars_packed<e5m2_k>("angulars_packed_e5m2_graniteamx", nk_dots_pack_size_e5m2_graniteamx,
    ...
    run_euclideans_packed<e5m2_k>("euclideans_packed_e5m2_graniteamx", nk_dots_pack_size_e5m2_graniteamx,
    ...
    run_attention_bidirectional<e4m3_k>("attention_bidirectional_packed_e4m3_diamondamx",
    ...
    run_attention_causal<e4m3_k>("attention_causal_packed_e4m3_diamondamx", nk_attention_pack_size_e4m3_diamondamx,
                                 nk_attention_pack_e4m3_diamondamx, nk_attention_causal_packed_e4m3_diamondamx);
#endif
}
