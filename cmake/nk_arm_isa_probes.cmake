...
nk_instruction_set_probe_(nk_target_neon "" "-march=armv8-a+simd" "probes/arm_neon.c")
# FEAT_FP16: optional from ARMv8.2, mandatory at ARMv9.0 with AdvSIMD
nk_instruction_set_probe_(nk_target_neonhalf "/arch:armv8.2" "-march=armv8.2-a+simd+fp16" "probes/arm_neon_half.c")
# FEAT_DotProd: optional from ARMv8.1, mandatory at ARMv8.4 with AdvSIMD
nk_instruction_set_probe_(nk_target_neonsdot "/arch:armv8.4" "-march=armv8.2-a+dotprod" "probes/arm_neon_sdot.c")
# FEAT_BF16: optional from ARMv8.2, mandatory at ARMv8.6 with FP
nk_instruction_set_probe_(nk_target_neonbfdot "/arch:armv8.6" "-march=armv8.6-a+simd+bf16" "probes/arm_neon_bfdot.c")
# FEAT_FHM: optional from ARMv8.1, mandatory at ARMv8.4 with FP16
nk_instruction_set_probe_(
    nk_target_neonfhm "/arch:armv8.4" "-march=armv8.2-a+simd+fp16+fp16fml" "probes/arm_neon_fhm.c"
)

# SVE probes
nk_instruction_set_probe_(nk_target_sve "" "-march=armv8.2-a+sve" "probes/arm_sve.c")
nk_instruction_set_probe_(nk_target_svehalf "" "-march=armv8.2-a+sve+fp16" "probes/arm_sve_half.c")
