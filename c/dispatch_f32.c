...
void nk_dispatch_f32_find_(nk_capability_t v, nk_kernel_kind_t k, nk_kernel_punned_t *m, nk_capability_t *c) {
    ...
    if (v & nk_cap_skylake_k) switch (k) {
        ...
        case nk_kernel_each_rope_k: *m = (m_t)&nk_each_rope_f32_skylake, *c = nk_cap_skylake_k; return;
    ...
    if (v & nk_cap_haswell_k) switch (k) {
        ...
        case nk_kernel_each_rope_k: *m = (m_t)&nk_each_rope_f32_haswell, *c = nk_cap_haswell_k; return;
    ...
    if (v & nk_cap_serial_k) switch (k) {
        ...
        case nk_kernel_each_rope_k: *m = (m_t)&nk_each_rope_f32_serial, *c = nk_cap_serial_k; return;
...
void nk_dispatch_f32_init_(nk_capability_t caps) {
    ...
    nk_dispatch_f32_find_(caps, nk_kernel_each_rope_k, (nk_kernel_punned_t *)&t->each_rope_f32, &used);
