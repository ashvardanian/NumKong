...
void nk_dispatch_i8_find_(nk_capability_t v, nk_kernel_kind_t k, nk_kernel_punned_t *m, nk_capability_t *c) {
    ...
    if (v & nk_cap_v128relaxed_k) switch (k) {
        ...
        case nk_kernel_attention_pack_size_k:
            *m = (m_t)&nk_attention_pack_size_i8_v128relaxed, *c = nk_cap_v128relaxed_k;
            return;
        case nk_kernel_attention_packed_shape_k:
            *m = (m_t)&nk_attention_packed_shape_i8_v128relaxed, *c = nk_cap_v128relaxed_k;
            return;
        case nk_kernel_attention_pack_k: *m = (m_t)&nk_attention_pack_i8_v128relaxed, *c = nk_cap_v128relaxed_k; return;
