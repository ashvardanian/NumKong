...
void nk_dispatch_bf16_find_(nk_capability_t v, nk_kernel_kind_t k, nk_kernel_punned_t *m, nk_capability_t *c) {
    ...
    if (v & nk_cap_sme_k) switch (k) {
        ...
        case nk_kernel_attention_packed_size_k: *m = (m_t)&nk_attention_packed_size_bf16_sme, *c = nk_cap_sme_k; return;
    ...
    if (v & nk_cap_neonbfdot_k) switch (k) {
        ...
        case nk_kernel_euclideans_symmetric_k:
            *m = (m_t)&nk_euclideans_symmetric_bf16_neonbfdot, *c = nk_cap_neonbfdot_k;
            return;
        case nk_kernel_attention_packed_size_k:
            *m = (m_t)&nk_attention_packed_size_bf16_neonbfdot, *c = nk_cap_neonbfdot_k;
            return;
    ...
    if (v & nk_cap_sapphireamx_k) switch (k) {
        ...
        case nk_kernel_attention_packed_size_k:
            *m = (m_t)&nk_attention_packed_size_bf16_sapphireamx, *c = nk_cap_sapphireamx_k;
            return;
        case nk_kernel_attention_pack_k:
    ...
    if (v & nk_cap_genoa_k) switch (k) {
        ...
        case nk_kernel_attention_packed_size_k:
            *m = (m_t)&nk_attention_packed_size_bf16_genoa, *c = nk_cap_genoa_k;
            return;
    ...
    if (v & nk_cap_skylake_k) switch (k) {
        ...
        case nk_kernel_attention_packed_size_k:
            *m = (m_t)&nk_attention_packed_size_bf16_skylake, *c = nk_cap_skylake_k;
            return;
    ...
    if (v & nk_cap_haswell_k) switch (k) {
        ...
        case nk_kernel_attention_packed_size_k:
            *m = (m_t)&nk_attention_packed_size_bf16_haswell, *c = nk_cap_haswell_k;
            return;
    ...
    if (v & nk_cap_serial_k) switch (k) {
        ...
        case nk_kernel_attention_packed_size_k:
            *m = (m_t)&nk_attention_packed_size_bf16_serial, *c = nk_cap_serial_k;
            return;
...
void nk_dispatch_bf16_init_(nk_capability_t caps) {
    ...
    nk_dispatch_bf16_find_(caps, nk_kernel_attention_packed_size_k,
                           (nk_kernel_punned_t *)&t->attention_packed_size_bf16, &used);
