...
void nk_dispatch_bf16_find_(nk_capability_t v, nk_kernel_kind_t k, nk_kernel_punned_t *m, nk_capability_t *c) {
    ...
    if (v & nk_cap_v128relaxed_k) switch (k) {
        ...
        case nk_kernel_maxsim_pack_size_k:
            *m = (m_t)&nk_maxsim_pack_size_bf16_v128relaxed, *c = nk_cap_v128relaxed_k;
            return;
        case nk_kernel_maxsim_packed_shape_k:
            *m = (m_t)&nk_maxsim_packed_shape_bf16_v128relaxed, *c = nk_cap_v128relaxed_k;
            return;
        ...
        case nk_kernel_attention_pack_size_k:
            *m = (m_t)&nk_attention_pack_size_bf16_v128relaxed, *c = nk_cap_v128relaxed_k;
            return;
        case nk_kernel_attention_packed_shape_k:
            *m = (m_t)&nk_attention_packed_shape_bf16_v128relaxed, *c = nk_cap_v128relaxed_k;
            return;
