...
void nk_dispatch_bf16_find_(nk_capability_t v, nk_kernel_kind_t k, nk_kernel_punned_t *m, nk_capability_t *c) {
    ...
    if (v & nk_cap_v128relaxed_k) switch (k) {
        ...
        case nk_kernel_dots_pack_size_k:
            *m = (m_t)&nk_dots_pack_size_bf16_v128relaxed, *c = nk_cap_v128relaxed_k;
            return;
        case nk_kernel_dots_packed_shape_k:
            *m = (m_t)&nk_dots_packed_shape_bf16_v128relaxed, *c = nk_cap_v128relaxed_k;
            return;
    ...
    if (v & nk_cap_v128_k) switch (k) {
        case nk_kernel_dot_k: *m = (m_t)&nk_dot_bf16_v128, *c = nk_cap_v128_k; return;
        case nk_kernel_angular_k: *m = (m_t)&nk_angular_bf16_v128, *c = nk_cap_v128_k; return;
        case nk_kernel_sqeuclidean_k: *m = (m_t)&nk_sqeuclidean_bf16_v128, *c = nk_cap_v128_k; return;
        case nk_kernel_euclidean_k: *m = (m_t)&nk_euclidean_bf16_v128, *c = nk_cap_v128_k; return;
        case nk_kernel_reduce_moments_k: *m = (m_t)&nk_reduce_moments_bf16_v128, *c = nk_cap_v128_k; return;
        case nk_kernel_maxsim_pack_size_k: *m = (m_t)&nk_maxsim_pack_size_bf16_v128, *c = nk_cap_v128_k; return;
        case nk_kernel_maxsim_packed_shape_k: *m = (m_t)&nk_maxsim_packed_shape_bf16_v128, *c = nk_cap_v128_k; return;
        case nk_kernel_maxsim_pack_k: *m = (m_t)&nk_maxsim_pack_bf16_v128, *c = nk_cap_v128_k; return;
        case nk_kernel_dots_pack_size_k: *m = (m_t)&nk_dots_pack_size_bf16_v128, *c = nk_cap_v128_k; return;
        case nk_kernel_dots_packed_shape_k: *m = (m_t)&nk_dots_packed_shape_bf16_v128, *c = nk_cap_v128_k; return;
        case nk_kernel_dots_pack_k: *m = (m_t)&nk_dots_pack_bf16_v128, *c = nk_cap_v128_k; return;
        case nk_kernel_dots_packed_k: *m = (m_t)&nk_dots_packed_bf16_v128, *c = nk_cap_v128_k; return;
        case nk_kernel_dots_symmetric_k: *m = (m_t)&nk_dots_symmetric_bf16_v128, *c = nk_cap_v128_k; return;
        case nk_kernel_angulars_packed_k: *m = (m_t)&nk_angulars_packed_bf16_v128, *c = nk_cap_v128_k; return;
        case nk_kernel_angulars_symmetric_k: *m = (m_t)&nk_angulars_symmetric_bf16_v128, *c = nk_cap_v128_k; return;
        case nk_kernel_euclideans_packed_k: *m = (m_t)&nk_euclideans_packed_bf16_v128, *c = nk_cap_v128_k; return;
        case nk_kernel_euclideans_symmetric_k: *m = (m_t)&nk_euclideans_symmetric_bf16_v128, *c = nk_cap_v128_k; return;
        case nk_kernel_each_sum_k: *m = (m_t)&nk_each_sum_bf16_v128, *c = nk_cap_v128_k; return;
        case nk_kernel_attention_pack_size_k: *m = (m_t)&nk_attention_pack_size_bf16_v128, *c = nk_cap_v128_k; return;
        case nk_kernel_attention_packed_shape_k:
            *m = (m_t)&nk_attention_packed_shape_bf16_v128, *c = nk_cap_v128_k;
            return;
        case nk_kernel_attention_pack_k: *m = (m_t)&nk_attention_pack_bf16_v128, *c = nk_cap_v128_k; return;
        default: break;
        }
#endif
#if NK_TARGET_SME
    if (v & nk_cap_sme_k) switch (k) {
        case nk_kernel_dots_pack_size_k: *m = (m_t)&nk_dots_pack_size_bf16_sme, *c = nk_cap_sme_k; return;
        case nk_kernel_dots_packed_shape_k: *m = (m_t)&nk_dots_packed_shape_bf16_sme, *c = nk_cap_sme_k; return;
        ...
        case nk_kernel_maxsim_pack_size_k: *m = (m_t)&nk_maxsim_pack_size_bf16_sme, *c = nk_cap_sme_k; return;
        case nk_kernel_maxsim_packed_shape_k: *m = (m_t)&nk_maxsim_packed_shape_bf16_sme, *c = nk_cap_sme_k; return;
        ...
        case nk_kernel_attention_pack_size_k: *m = (m_t)&nk_attention_pack_size_bf16_sme, *c = nk_cap_sme_k; return;
        case nk_kernel_attention_packed_shape_k:
    ...
    if (v & nk_cap_neonbfdot_k) switch (k) {
        ...
        case nk_kernel_dots_pack_size_k: *m = (m_t)&nk_dots_pack_size_bf16_neonbfdot, *c = nk_cap_neonbfdot_k; return;
        case nk_kernel_dots_packed_shape_k:
            *m = (m_t)&nk_dots_packed_shape_bf16_neonbfdot, *c = nk_cap_neonbfdot_k;
            return;
        ...
        case nk_kernel_attention_pack_size_k:
            *m = (m_t)&nk_attention_pack_size_bf16_neonbfdot, *c = nk_cap_neonbfdot_k;
            return;
        case nk_kernel_attention_packed_shape_k:
    ...
    if (v & nk_cap_neon_k) switch (k) {
        ...
        case nk_kernel_dots_pack_size_k: *m = (m_t)&nk_dots_pack_size_bf16_neon, *c = nk_cap_neon_k; return;
        case nk_kernel_dots_packed_shape_k: *m = (m_t)&nk_dots_packed_shape_bf16_neon, *c = nk_cap_neon_k; return;
    ...
    if (v & nk_cap_sapphireamx_k) switch (k) {
        case nk_kernel_dots_pack_size_k:
            *m = (m_t)&nk_dots_pack_size_bf16_sapphireamx, *c = nk_cap_sapphireamx_k;
            return;
        case nk_kernel_dots_packed_shape_k:
            *m = (m_t)&nk_dots_packed_shape_bf16_sapphireamx, *c = nk_cap_sapphireamx_k;
            return;
        ...
        case nk_kernel_maxsim_pack_size_k:
            *m = (m_t)&nk_maxsim_pack_size_bf16_sapphireamx, *c = nk_cap_sapphireamx_k;
            return;
        case nk_kernel_maxsim_packed_shape_k:
            *m = (m_t)&nk_maxsim_packed_shape_bf16_sapphireamx, *c = nk_cap_sapphireamx_k;
            return;
        ...
        case nk_kernel_attention_pack_size_k:
            *m = (m_t)&nk_attention_pack_size_bf16_sapphireamx, *c = nk_cap_sapphireamx_k;
            return;
        case nk_kernel_attention_packed_shape_k:
            *m = (m_t)&nk_attention_packed_shape_bf16_sapphireamx, *c = nk_cap_sapphireamx_k;
            return;
    ...
    if (v & nk_cap_genoa_k) switch (k) {
        ...
        case nk_kernel_dots_pack_size_k: *m = (m_t)&nk_dots_pack_size_bf16_genoa, *c = nk_cap_genoa_k; return;
        case nk_kernel_dots_packed_shape_k: *m = (m_t)&nk_dots_packed_shape_bf16_genoa, *c = nk_cap_genoa_k; return;
        ...
        case nk_kernel_maxsim_pack_size_k: *m = (m_t)&nk_maxsim_pack_size_bf16_genoa, *c = nk_cap_genoa_k; return;
        case nk_kernel_maxsim_packed_shape_k: *m = (m_t)&nk_maxsim_packed_shape_bf16_genoa, *c = nk_cap_genoa_k; return;
        ...
        case nk_kernel_attention_pack_size_k: *m = (m_t)&nk_attention_pack_size_bf16_genoa, *c = nk_cap_genoa_k; return;
        case nk_kernel_attention_packed_shape_k:
    ...
    if (v & nk_cap_skylake_k) switch (k) {
        ...
        case nk_kernel_trig_rope_k: *m = (m_t)&nk_trig_rope_bf16_skylake, *c = nk_cap_skylake_k; return;
        case nk_kernel_dots_pack_size_k: *m = (m_t)&nk_dots_pack_size_bf16_skylake, *c = nk_cap_skylake_k; return;
        case nk_kernel_dots_packed_shape_k: *m = (m_t)&nk_dots_packed_shape_bf16_skylake, *c = nk_cap_skylake_k; return;
        ...
        case nk_kernel_attention_pack_size_k:
            *m = (m_t)&nk_attention_pack_size_bf16_skylake, *c = nk_cap_skylake_k;
            return;
        case nk_kernel_attention_packed_shape_k:
    ...
    if (v & nk_cap_alder_k) switch (k) {
        case nk_kernel_maxsim_pack_size_k: *m = (m_t)&nk_maxsim_pack_size_bf16_alder, *c = nk_cap_alder_k; return;
        case nk_kernel_maxsim_packed_shape_k: *m = (m_t)&nk_maxsim_packed_shape_bf16_alder, *c = nk_cap_alder_k; return;
    ...
    if (v & nk_cap_haswell_k) switch (k) {
        ...
        case nk_kernel_trig_rope_k: *m = (m_t)&nk_trig_rope_bf16_haswell, *c = nk_cap_haswell_k; return;
        case nk_kernel_dots_pack_size_k: *m = (m_t)&nk_dots_pack_size_bf16_haswell, *c = nk_cap_haswell_k; return;
        case nk_kernel_dots_packed_shape_k: *m = (m_t)&nk_dots_packed_shape_bf16_haswell, *c = nk_cap_haswell_k; return;
        ...
        case nk_kernel_maxsim_pack_size_k: *m = (m_t)&nk_maxsim_pack_size_bf16_haswell, *c = nk_cap_haswell_k; return;
        case nk_kernel_maxsim_packed_shape_k:
            *m = (m_t)&nk_maxsim_packed_shape_bf16_haswell, *c = nk_cap_haswell_k;
            return;
        ...
        case nk_kernel_attention_pack_size_k:
            *m = (m_t)&nk_attention_pack_size_bf16_haswell, *c = nk_cap_haswell_k;
            return;
        case nk_kernel_attention_packed_shape_k:
    ...
    if (v & nk_cap_neonsdot_k) switch (k) {
        case nk_kernel_maxsim_pack_size_k: *m = (m_t)&nk_maxsim_pack_size_bf16_neonsdot, *c = nk_cap_neonsdot_k; return;
        case nk_kernel_maxsim_packed_shape_k:
            *m = (m_t)&nk_maxsim_packed_shape_bf16_neonsdot, *c = nk_cap_neonsdot_k;
            return;
    ...
    if (v & nk_cap_rvv_k) switch (k) {
        ...
        case nk_kernel_dots_pack_size_k: *m = (m_t)&nk_dots_pack_size_bf16_rvv, *c = nk_cap_rvv_k; return;
        case nk_kernel_dots_packed_shape_k: *m = (m_t)&nk_dots_packed_shape_bf16_rvv, *c = nk_cap_rvv_k; return;
    ...
    if (v & nk_cap_powervsx_k) switch (k) {
        ...
        case nk_kernel_dots_pack_size_k: *m = (m_t)&nk_dots_pack_size_bf16_powervsx, *c = nk_cap_powervsx_k; return;
        case nk_kernel_dots_packed_shape_k:
            *m = (m_t)&nk_dots_packed_shape_bf16_powervsx, *c = nk_cap_powervsx_k;
            return;
    ...
    if (v & nk_cap_loongsonasx_k) switch (k) {
        ...
        case nk_kernel_dots_pack_size_k:
            *m = (m_t)&nk_dots_pack_size_bf16_loongsonasx, *c = nk_cap_loongsonasx_k;
            return;
        case nk_kernel_dots_packed_shape_k:
            *m = (m_t)&nk_dots_packed_shape_bf16_loongsonasx, *c = nk_cap_loongsonasx_k;
            return;
...
#if NK_TARGET_RVV
    if (v & nk_cap_rvv_k) switch (k) {
        case nk_kernel_attention_pack_size_k: *m = (m_t)&nk_attention_pack_size_bf16_rvv, *c = nk_cap_rvv_k; return;
        case nk_kernel_attention_packed_shape_k:
    ...
    if (v & nk_cap_serial_k) switch (k) {
        ...
        case nk_kernel_trig_rope_k: *m = (m_t)&nk_trig_rope_bf16_serial, *c = nk_cap_serial_k; return;
        ...
        case nk_kernel_dots_pack_size_k: *m = (m_t)&nk_dots_pack_size_bf16_serial, *c = nk_cap_serial_k; return;
        case nk_kernel_dots_packed_shape_k: *m = (m_t)&nk_dots_packed_shape_bf16_serial, *c = nk_cap_serial_k; return;
        ...
        case nk_kernel_euclideans_symmetric_k:
            *m = (m_t)&nk_euclideans_symmetric_bf16_serial, *c = nk_cap_serial_k;
            return;
        case nk_kernel_maxsim_pack_size_k: *m = (m_t)&nk_maxsim_pack_size_bf16_serial, *c = nk_cap_serial_k; return;
        case nk_kernel_maxsim_packed_shape_k:
            *m = (m_t)&nk_maxsim_packed_shape_bf16_serial, *c = nk_cap_serial_k;
            return;
        ...
        case nk_kernel_attention_pack_size_k:
            *m = (m_t)&nk_attention_pack_size_bf16_serial, *c = nk_cap_serial_k;
            return;
        case nk_kernel_attention_packed_shape_k:
...
void nk_dispatch_bf16_init_(nk_capability_t caps) {
    ...
    nk_dispatch_bf16_find_(caps, nk_kernel_trig_rope_k, (nk_kernel_punned_t *)&t->trig_rope_bf16, &used);
    ...
    nk_dispatch_bf16_find_(caps, nk_kernel_dots_pack_size_k, (nk_kernel_punned_t *)&t->dots_pack_size_bf16, &used);
    nk_dispatch_bf16_find_(caps, nk_kernel_dots_packed_shape_k, (nk_kernel_punned_t *)&t->dots_packed_shape_bf16,
                           &used);
    ...
    nk_dispatch_bf16_find_(caps, nk_kernel_euclideans_symmetric_k, (nk_kernel_punned_t *)&t->euclideans_symmetric_bf16,
                           &used);
    nk_dispatch_bf16_find_(caps, nk_kernel_maxsim_pack_size_k, (nk_kernel_punned_t *)&t->maxsim_pack_size_bf16, &used);
    nk_dispatch_bf16_find_(caps, nk_kernel_maxsim_packed_shape_k, (nk_kernel_punned_t *)&t->maxsim_packed_shape_bf16,
                           &used);
    ...
    nk_dispatch_bf16_find_(caps, nk_kernel_attention_pack_size_k, (nk_kernel_punned_t *)&t->attention_pack_size_bf16,
                           &used);
