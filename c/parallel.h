 ...
 *  @p threads of 0 means every logical processor, and 1 runs the tiles inline on the calling thread
 *  with no pool involved. Returns once every tile has completed. The caller must release the GIL if
 *  the bodies do not need it.
 */
