...
void test_cross_power() {
    ...
    check("angulars_packed_f64_powervsx", test_angulars_packed<f64_t>, nk_dots_pack_size_f64_powervsx,
          nk_dots_pack_f64_powervsx, nk_angulars_packed_f64_powervsx);
    check("angulars_packed_f32_powervsx", test_angulars_packed<f32_t>, nk_dots_pack_size_f32_powervsx,
          nk_dots_pack_f32_powervsx, nk_angulars_packed_f32_powervsx);
    check("angulars_packed_f16_powervsx", test_angulars_packed<f16_t>, nk_dots_pack_size_f16_powervsx,
          nk_dots_pack_f16_powervsx, nk_angulars_packed_f16_powervsx);
    check("angulars_packed_bf16_powervsx", test_angulars_packed<bf16_t>, nk_dots_pack_size_bf16_powervsx,
    ...
    check("euclideans_packed_f64_powervsx", test_euclideans_packed<f64_t>, nk_dots_pack_size_f64_powervsx,
          nk_dots_pack_f64_powervsx, nk_euclideans_packed_f64_powervsx);
    check("euclideans_packed_f32_powervsx", test_euclideans_packed<f32_t>, nk_dots_pack_size_f32_powervsx,
          nk_dots_pack_f32_powervsx, nk_euclideans_packed_f32_powervsx);
    check("euclideans_packed_f16_powervsx", test_euclideans_packed<f16_t>, nk_dots_pack_size_f16_powervsx,
          nk_dots_pack_f16_powervsx, nk_euclideans_packed_f16_powervsx);
    check("euclideans_packed_bf16_powervsx", test_euclideans_packed<bf16_t>, nk_dots_pack_size_bf16_powervsx,
    ...
    check("hammings_packed_u1_powervsx", test_hammings_packed<u1x8_t>, nk_dots_pack_size_u1_powervsx,
